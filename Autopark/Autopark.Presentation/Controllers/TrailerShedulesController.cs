...
[Route("api/trailers/schedules/{id}")]
[ApiController]
[Authorize(Roles = "manager, admin")]
public class TrailerSchedulesController : ControllerBase
{
	private readonly ITrailerScheduleService _scheduleService;
	
	public TrailerSchedulesController(ITrailerScheduleService scheduleService)
	{
